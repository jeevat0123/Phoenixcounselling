...
export class IndividualcounselingComponent {
  ...
  pageServiceData = {
    bannerTittle: 'Individual Counseling',
  ...
  `,
    faqs: [
      {
        question: 'What Happens During One On One Individual Therapy Counseling In Chennai?',
