...
@Component({
  selector: 'app-onlinecounseling',
  standalone: true,
  imports: [PageServiceComponent],
  templateUrl: './onlinecounseling.component.html',
  styleUrl: './onlinecounseling.component.css'
})
export class OnlinecounselingComponent {
  pageServiceData = {
    bannerTittle: 'Online Counseling',
    ...
    serviceContent: 'Online counseling, also known as e-counseling or teletherapy, is a form of therapy conducted via digital platforms, such as video calls, emails, or chat, allowing individuals to receive mental health support remotely. This approach offers convenience and accessibility, making it easier for people to connect with licensed therapists from the comfort of their own homes. In Online counseling Phoenix Psychological Services address various issues, including anxiety, depression, relationship problems, and more, providing the same professional care as in-person sessions. It’s particularly beneficial for those with busy schedules, mobility issues, or living in remote areas, ensuring they can still access the support they need.',
    imagePath: '../assets/img/online/online.png',
    whatHappensContent: 'Online counseling involves connecting with a licensed therapist through digital platforms like video calls, chats, or phone sessions. It provides a safe, flexible, and convenient space for individuals to discuss their mental health concerns, work through challenges, and develop coping strategies, all from the comfort of their home.',
    ...
    <p class="para-text">These benefits make online counseling a versatile and accessible option for receiving mental health support.</p>`,
    faqs: [
      {
        question: 'Is online counseling as effective as in-person therapy?',
        answer: 'Yes, studies show that online counseling is just as effective as traditional therapy for many mental health issues, including anxiety and depression.'
      },
      {
        question: 'What tools or devices do I need for online counseling?',
      ...
      {
        question: 'How do I ensure privacy during online counseling sessions?',
