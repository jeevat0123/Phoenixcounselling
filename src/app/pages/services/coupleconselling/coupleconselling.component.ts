...
export class CoupleconsellingComponent {
  ...
  pageServiceData = {
    ...
    benefitsHtml: `
<h4 _ngcontent-ng-c4140733568="">Conflict Resolution: 🔄</h4><p _ngcontent-ng-c4140733568="" class="para-text">Conflict resolution stands as a pivotal and indispensable facet of couples Counselling, playing a pivotal role in helping partners to navigate the inevitable disagreements and tensions that arise within any relationship. When couples seek professional guidance and support through couples Counselling services, they embark on a journey towards developing the skills, insights, and strategies required to address conflicts in a manner that not only resolves immediate issues but also promotes the overall health and longevity of their partnership. </p><h4 _ngcontent-ng-c4140733568="">Rebuilding Trust: 🤝</h4><p _ngcontent-ng-c4140733568="" class="para-text">Rebuilding trust within the context of couples Counselling is an intricate and delicate process, particularly when a relationship has been marred by significant breaches of trust or acts of betrayal. Trust is the cornerstone of any healthy and enduring relationship, and when it is compromised, it can lead to emotional wounds and a sense of vulnerability that can be challenging to overcome. </p><h4 _ngcontent-ng-c4140733568=""> Emotional Connection: ❤️</h4><p _ngcontent-ng-c4140733568="" class="para-text">Emotional Counselling is an integral part of couples Counselling, focusing on the emotional well-being of both partners and the relationship as a whole. It plays a crucial role in helping couples navigate their emotions, express themselves, and foster a deeper understanding of their own feelings and those of their partner. </p>
  `,
    faqs: [
      {
